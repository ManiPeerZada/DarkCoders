 ...
 <!-- ChartJS -->
 <script src="{{ asset('back/plugins/sweetalert2/sweetalert.min.js') }}"></script>
...
<link rel="stylesheet" href="{{asset('back/plugins/jquery-ui/jqueri-ui.css')}}">
  <script src="{{asset('back/plugins/jquery-ui/jqueri-ui.js')}}"></script>
<script>$('.date_pick').datepicker({ dateFormat: 'mm-dd-yy' }).val();</script>
